  ...
  return (
      <div className="header">
           <div className="logo-container">
            <img className="logo" src={ require("./food_plasa_image.png" )} alt="logo"/>
           </div>
...
const Body = () =>{
  ...
  <div className="body" > 
     ...
     <div className="res-container">
      ...
      {/* Instead of Making call for each an angry restaurant card we can use map to iterate the restaurant cards of different types */}

        { resList.map( (restaurant) => (
          <RestaurantCard key = {restaurant.data.id} resData = { restaurant } />
          ) ) } ;

           {/* resList = > array  , So we can perform array method operation map , For each restaurant ( object ) I'm returning a piece of JSX code . Map needs a callback function */}

      {/* <RestaurantCard resData = {resList[0]} />    
      {/* Instead of passing restaurant name cuisines stars image time we have just passed the javascript json object to the restaurant data */}
      ...
      {/* <RestaurantCard resName = "Raju Bhature" cuisine = "choleBhature , Indian" stars ="4.8 stars" time = "20mins" imageSrc = "./choleBhature.jpg" />  */}
     </div>
  </div>
  ) ;
} ;
